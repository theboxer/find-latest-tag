...
async function run() {
    try {
        ...
        core.setOutput("tag", await getLatestTag(owner, repo, prefix, suffix, releasesOnly, sortTags));
    } catch (error) {
...
async function getLatestTag(owner, repo, prefix, suffix, releasesOnly, sortTags) {
